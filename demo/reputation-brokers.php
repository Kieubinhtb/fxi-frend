    ...
    <div id="contents">
        <div class="container">
            <div class="content-top content-top--larger">
                ...
                <p class="mb-0 text-center">Danh sách các sàn giao dịch uy tín được chúng tôi đề xuất dựa vào mức độ uy tín của các giấy phép mà các sàn đang sở hữu. Tuy nhiên, các traders cũng nên tham khảo thêm các <a href="./review.php">nhận xét và đánh giá</a> từ nhà đầu tư khác. Việc mở tài khoản với các sàn giao dịch sở hữu giấy phép uy tín chỉ giúp hạn chế rủi ro này. </p>
            </div>
                ...
                <li>
                    <div class="reputation-item">
                        <div class="row align-items-center">
                            <div class="col-6 col-md-3 col-lg-4 reputation-item__logo"><a href="./detail-broker.php" class="img-hover"><img src="./assets/images/logo/xtb-logo3.png" alt="XTB"></a></div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="filter-broker-desc">
                                            ...
                                            <p class="mb-0 font-weight-bold filter-broker-desc__txt">FCA, CySEC</p>
                                        </div>
                                        <div class="filter-broker-desc">
                                            <h3 class="filter-broker-desc__label">Năm thành lập :</h3>
                                            <p class="mb-0 font-weight-bold filter-broker-desc__txt">2005</p>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="filter-broker-desc">
                                        ...
                                        <div class="filter-broker-desc">
                                            ...
                                            <p class="mb-0 font-weight-bold filter-broker-desc__txt">30 đánh giá</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-3 col-lg-3 pl-0">
                                <div class="reputation-item__action ml-auto">
                                    ...
                                    <p class="mb-0"><a href="#" target="_blank" class="btn btn-primary btn-medium-size font-14">Mở tài khoản</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
