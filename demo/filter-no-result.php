            ...
            <div class="container">
                <div class="clearfix" data-sticky_parent>
                                ...
                                <div class="filter-side">
                                    <form action="#" method="get">
                                        ...
                                        <div class="filter-side__footer d-none d-md-flex justify-content-between">
                                            ...
                                            <button type="submit" name="submit-filter" class="btn btn-primary btn-filter">Lọc kết quả</button>
                                        </div>
                                        <div class="d-md-none">
                    ...
                    <div class="contents-main contents-main--right" data-sticky_column>
                        <div class="no-result">
                            <p><img src="./assets/images/result-search.svg" alt="no result"></p>
                            <p class="no-result__main">Không có sàn nào phù hợp với nhu cầu tìm kiếm của bạn.</p>
                            <p class="no-result__txt">Đăng ký tham gia vào cộng đồng broker miễn phí với chúng tôi <a href="#" class="btn-link">Tại đây</a></p>
                        </div>
                    </div>
                </div>
            </div>
