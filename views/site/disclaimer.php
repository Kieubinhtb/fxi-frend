...
<div id="contents">
    ...
    <div class="container">
        ...
        <div class="content-top mw-100 pb-0">

            <h1 class="title-h1">Tuyên bố miễn trừ</h1>

            <p class="text-justify">

                Chúng tôi, <a href="/">https://fxinsites.com/</a> (sau đây được gọi là ‘Trang’, Chúng tôi’) và hoặc các nhà cấp phép, không đảm bảo hay đại diện cho bất cứ điều gì liên quan đến Trang, Sản phẩm, và Dịch vụ, hay bất kỳ trang liên kết nào hay nội dung trong đó, bao gồm nội dung, thông tin và tài liệu trong đó hay độ chính xác, hoàn thiện, hay kịp thời của nội dung, thông tin và tài liệu.<br>

                Chúng tôi cũng không đảm bảo hay đại diện rằng việc bạn truy cập hay sử dụng Trang, Sản phẩm, và/hoặc Dịch vụ, hay bất kỳ trang liên kết nào, sẽ không bị gián đoạn hay không có lỗi hay thiếu sót, rằng các thiếu sót sẽ được sửa chữa, hay rằng Trang, Sản phẩm, và/hoặc Dịch vụ, hay bất kỳ trang liên kết nào đều không có virus hay các thành phần có hại khác.<br>

                Chúng tôi không có trách nhiệm, và sẽ không chịu trách nhiệm đối với bất kỳ thiệt hại, hay virus nào có thể ảnh hưởng đến thiết bị máy tính hay tài sản khác trên tài khoản mà bạn dùng cho các Sản phẩm hay Dịch vụ, hay việc bạn truy cập, sử dụng, tải Trang, hay việc bạn download hay upload bất kỳ Nội dung nào từ hoặc đến Trang. Nếu bạn không thỏa mãn với Trang, cách xử lý duy nhất là không tiếp tục sử dụng Trang. Không lời khuyên, kết quả hay thông tin nào, dù dạng nói hay văn bản, mà bạn có được từ Chúng tôi, hay thông qua Trang, có thể tạo ra bất kỳ sự bảo đảm nào không được đưa ra rõ ràng ở đây.<br>

                Chúng tôi không nhất thiết xác nhận, hỗ trợ, xử phạt, khuyến khích hay đồng ý với bất kỳ nội dung nào hay nội dung người dùng nào, hay bất kỳ quan niệm, đề xuất, nội dung, link, dữ liệu hay lời khuyên nào được thể hiện hay ngụ ý trong đó, và Chúng tôi công khai từ chối bất kỳ và mọi trách nhiệm liên kết với nội dung người dùng và bất kỳ nội dung người dùng nào, tài liệu hay thông tin khả dụng trên hay khắp Trang, Sản phẩm, và/hoặc Dịch vụ của chúng tôi, được tạo hay cung cấp bởi những người dùng hay các bên thứ ba khác.<br>
