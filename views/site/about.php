...
function Curl_index($url, $options = [], $method)
    {
...
// // curl_setopt($ch, CURLOPT_URL, 'http://api.fxinsites.com/v1/cronjobs/telegram-msg?id=1');
// // curl_setopt($ch, CURLOPT_URL, 'https://api.telegram.org/bot1320116583:AAHlnnw9Y9nh29nCZtfTFfXrqaWMEeEqkjk/getChatAdministrators');
// // curl_setopt($ch, CURLOPT_URL, 'https://news.fxinsites.com/index.php/wp-json/wp/v2/posts?per_page=4&categories=276');
// curl_setopt($ch, CURLOPT_URL, 'http://api.fxinsites.com/v1/pages/filter');
// // curl_setopt($ch, CURLOPT_POST, 1);
// // curl_setopt($ch, CURLOPT_POSTFIELDS, [
// //     "name" => "Click Trades",
// //     // "full_name" => "Trần trung hậu",
// //     // "email" => "trugnhau@gmail.com",
// //     // "rate_one" => 5,
// //     // "rate_two" => 5,
// //     // "rate_three" => 5,
// //     // "message" => 5,
...
$is_ok = Curl_index('http://api.fxinsites.com/v1/pages/filter', ["name" => "Click Trades"], 'get');//('http://api.fxinsites.com/v1/cronjobs/telegram-msg?id=1');
echo "<pre>";
print_r($is_ok);
echo "</pre>";